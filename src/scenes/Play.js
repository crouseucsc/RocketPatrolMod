class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.p1Rocket = new P1Rocket(this, game.config.width / 2 - 320, game.config.height - borderUISize - borderPadding, 'p1Rocket'); //Spawn coordinate.
        this.p2Rocket = new P2Rocket(this, game.config.width / 2 + 320, game.config.height - borderUISize - borderPadding, 'p2Rocket'); //Spawn coordinate.
