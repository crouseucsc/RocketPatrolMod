class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.ship04 = new Bomber (this, game.config.width + borderUISize * 10, borderUISize * 3.5, 'bomber', 0, 100).setOrigin(0, 0); //OMG THAT'S WHERE THE SCORE IS! I thought that was just coordinates.
        // define keys (p1)
